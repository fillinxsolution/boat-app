                ...
                <div class="row">
                    <div class="col-xl-7 col-12">
                        <div class="row mb-0">
                            ...
                            <div class="col-sm-8">{{ isset($supplier->login_with_facebook) ? $supplier->login_with_facebook : 'N/A' }}</div>
                    ...
                    <div class="col-xl-5 col-12">
                        <div class="row mb-0">
                            ...
                            <div class="col-sm-8">{{ isset($supplier->login_with_google) ? $supplier->login_with_google : 'N/A' }}</div>
